...
public class IntegrationTests{
	...
	public void integrationTest1() throws Exception{
		...
		assertEquals(ChemicalEntityType.exact, product.getEntityType());
		...
		assertEquals(ChemicalEntityType.exact, reactant1.getEntityType());
		...
		assertEquals(ChemicalEntityType.exact, reactant2.getEntityType());
		...
		assertEquals(ChemicalEntityType.exact, reactant3.getEntityType());
		...
		assertEquals(ChemicalEntityType.exact, spectator.getEntityType());
